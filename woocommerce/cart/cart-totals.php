...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<h5 class="m-text20 p-b-24"><?php esc_html_e( 'Cart totals', 'aranoz' ); ?></h5>

	<table cellspacing="0" class="shop_table shop_table_responsive">

		<tr class="cart-subtotal">
			<th><?php esc_html_e( 'Subtotal', 'aranoz' ); ?></th>
			<td data-bs-title="<?php esc_attr_e( 'Subtotal', 'aranoz' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
		</tr>
		...
		<?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
			...
			<tr class="shipping">
				<th><?php esc_html_e( 'Shipping', 'aranoz' ); ?></th>
				<td data-bs-title="<?php esc_attr_e( 'Shipping', 'aranoz' ); ?>"><?php woocommerce_shipping_calculator(); ?></td>
			</tr>
		...
		if ( wc_tax_enabled() && ! WC()->cart->display_prices_including_tax() ) :
			...
			$estimated_text  = WC()->customer->is_customer_outside_base() && ! WC()->customer->has_calculated_shipping()
					? sprintf( ' <small>' . __( '(estimated for %s)', 'aranoz' ) . '</small>', WC()->countries->estimated_for_prefix( $taxable_address[0] ) . WC()->countries->countries[ $taxable_address[0] ] )
					: '';
		...
		<tr class="order-total">
			<th><?php esc_html_e( 'Total', 'aranoz' ); ?></th>
			<td data-bs-title="<?php esc_attr_e( 'Total', 'aranoz' ); ?>"><?php wc_cart_totals_order_total_html(); ?></td>
		</tr>
