...
// image default alt
if( !function_exists( 'aranoz_img_default_alt' ) ){
	function aranoz_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'aranoz_img_tag' ) ){
	function aranoz_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = aranoz_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'aranoz_anchor_tag' ) ){
	function aranoz_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'aranoz_heading_tag' ) ){
	function aranoz_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'aranoz_paragraph_tag' ) ){
	function aranoz_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'aranoz_other_tag' ) ){
	function aranoz_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'aranoz_button_element ' ) ){
	function aranoz_button_element( array $args ){
