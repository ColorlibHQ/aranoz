...
----------------------------------------*/
class aranoz_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('aranoz_instagram_photo',esc_html__('[ Aranoz ] Intagram Photo','aranoz'),array(
			'description' => esc_html__('Aranoz Instagram Photo Widget','aranoz'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'aranoz');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'aranoz'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'aranoz'); ?></label>
...
if(!function_exists('aranoz_instagram_widgets')):
	function aranoz_instagram_widgets(){
		register_widget('aranoz_instagram_photo');
	}
	add_action('widgets_init','aranoz_instagram_widgets');
endif;
